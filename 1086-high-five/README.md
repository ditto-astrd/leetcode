<h2><a href="https://leetcode.com/problems/high-five/?envType=study-plan-v2&envId=premium-algo-100">1086. High Five</a></h2><h3>Easy</h3><hr><p>Given a list of the scores of different students, <code>items</code>, where <code>items[i] = [ID<sub>i</sub>, score<sub>i</sub>]</code> represents one score from a student with <code>ID<sub>i</sub></code>, calculate each student&#39;s <strong>top five average</strong>.</p>
